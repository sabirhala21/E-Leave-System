                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                          <?php
                                             if (isset($_GET['id'])) {
                                                $id=$_GET['id'];
                                                $query="select studentleave.id,studentreg.firstname,studentreg.lastname,studentleave.leavetype,studentleave.fromdate,studentleave.todate,studentleave.discription,studentleave.applyeddate,studentleave.facultyremark,studentleave.facultyremarkdate,studentleave.statusfaculty from studentleave join studentreg on studentleave.empid=studentreg.id where studentleave.id='$id'";
...
if($stats=='pending'){
 ...
 <?php } ?>
                                        ...
                                        <tr>
                                         ...
                                         <input type="submit" name="takeactionfaculty_student" value="Take Action" class="btn btn-primary">
                                          </td>
                                           </tr>
