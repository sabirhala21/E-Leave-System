        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
				...
				<div class="row">
					...
					<div class="col-sm-11">
						<a href="apply_faculty.php" class="btn btn-primary pull-right"><span class="fa fa-plus">&nbsp;Apply For Leave</span> </a>
                    </div>
                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                 <th>No.</th>  
                                                 <th>ID</th> <th>Leave Type</th><th>From Date</th><th>To date</th><th>Discription</th><th>Posting Date</th><th>HOD Remark</th><th>Principal Remark</th><th>Status HOD</th><th>Status Principal</th><th>Edit</th><th>Delete</th><th>Take Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                         <?php 
										 	$Srno=0;
										 	    $q="select * from hodreg where userid='$id'";
                                                $e=mysqli_query($conn,$q);
                                                $r=mysqli_fetch_array($e);
                                                $dep=$r['id'];
                    $query="select * from facultyleave where hodid='$dep'";
...
if($stats2=='pending'){
 ...
 <?php } ?>
                                             ...
                                             if ($stats1=='pending') {
                                                 ?>
                                                 <td style="width:50px"><a href="takeaction_faculty.php?id=<?php echo $row['id']; ?>" class="btn btn-primary pull-right"><span class="fa fa-plus">&nbsp;View Details</span> </a></td> 
                                                 <?php
                                             }
