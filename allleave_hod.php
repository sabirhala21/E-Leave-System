                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                 <th>No.</th>  
                                                 <th>Name</th>                                           
                                                 <th>Leave Type</th><th>From Date</th><th>To date</th><th>Discription</th><th>Posting Date</th><th>Principal Remark</th><th>Status</th>
                                        ...
                                        <tbody>
                                         <?php 
                                            $Srno=0;
                                            $que="select hodleave.id,hodreg.firstname,hodreg.lastname,hodleave.leavetype,hodleave.fromdate,hodleave.todate,hodleave.discription,hodleave.applyeddate,hodleave.principalremark,hodleave.principalremarkdate,hodleave.status from hodleave join hodreg on hodleave.empid=hodreg.id";
