                    ...
                    <div class="row">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                          <?php
                                             if (isset($_GET['id'])) {
                                                $id=$_GET['id'];
                                                $query="select studentleave.id,studentreg.firstname,studentreg.lastname,studentleave.leavetype,studentleave.fromdate,studentleave.todate,studentleave.discription,studentleave.applyeddate,studentleave.facultyremark,studentleave.facultyremarkdate,studentleave.statusfaculty,studentleave.hodremark,studentleave.hodremarkdate,studentleave.statushod from studentleave join studentreg on studentleave.empid=studentreg.id where studentleave.id='$id'";
                     ...
                     ?>
                                          ...
                                          <tr>
                                           ...
                                           <tr>
                                            <td style="font-size:16px;"> <b>Faculty Remark:</b></td>
                                              <td><?php echo $row['facultyremark']; ?></td>
                                         
                                            <td style="font-size:16px;"> <b>Faculty Remark Date:</b></td>
                                              <td><?php echo $row['facultyremarkdate']; ?></td>
...
if($stats1=='pending'){
 ...
 <?php } ?>
                                        ...
                                        <tr>
                                         ...
                                         <input type="submit" name="takeactionhod_student" value="Take Action" class="btn btn-primary">
                                          </td>
                                           </tr>
