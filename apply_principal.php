...
{
    $query = 'select * from principalleave where id='.$_GET['id'];
...
<html>
    ...
    ?>
                ...
                <hr/>
                <input type="submit" class="btn btn-primary" value="<?php echo($action !='action.php?action=update' ? "Save" : "Update")?>"  id="btnapply" name="btnapply" />               
                <a href="principal_history.php" class="btn btn-primary">Cancel</a>
                </div> <!--wrapper div end-->
                    </form>
