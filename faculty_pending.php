                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                         <?php 
										 	$Srno=0;
										 	$query="select facultyleave.id,empreg.firstname,empreg.lastname,facultyleave.leavetype,facultyleave.applyeddate,facultyleave.statushod from facultyleave join empreg on facultyleave.empid=empreg.id where facultyleave.statushod='pending' AND facultyleave.hodid".$_SESSION['id'];
