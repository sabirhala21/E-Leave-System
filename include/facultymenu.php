...
<aside class="left-side sidebar-offcanvas">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      <li <?php echo $a1; ?>><a href="faculty_profile.php?id=<?php echo $_SESSION['id']; ?>"><span>Profile<i class="glyphicon glyphicon-user" style="margin-left: 135px;"></i></a></li>
     
      <li class="treeview <?php echo $a4; ?>"> <a href="#"> <span>My Leaves</span> <i class="fa fa-angle-left pull-right"></i> </a>
        <ul class="treeview-menu">
          <li <?php echo $a2; ?>><a href="faculty_history.php"><i class="fa fa-angle-double-right"></i>Leave History</a></li>
             <li <?php echo $a2; ?>><a href="approvedleave_faculty.php"><i class="fa fa-angle-double-right"></i>Approved Leave</a></li>
                <li <?php echo $a2; ?>><a href="rejected_faculty.php"><i class="fa fa-angle-double-right"></i>Rejected Leave</a></li>
               <li <?php echo $a2; ?>><a href="mypending_faculty.php"><i class="fa fa-angle-double-right"></i>Pending Leave</a></li>
        </ul>
      </li>
      ...
      <li class="treeview <?php echo $a6; ?>"> <a href="#"> <span>Leave Management</span> <i class="fa fa-angle-left pull-right"></i> </a>
        <ul class="treeview-menu">
            ...
            <li <?php echo $a3; ?>><a href="student_pending.php"><i class="fa fa-angle-double-right"></i>Pending Leaves Student</a></li>
        </ul>
      </li>
      <li  <?php echo $a1; ?>><a href="changepassword_faculty.php"><span>Change Password</span></a></li>
