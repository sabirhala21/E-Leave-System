...
<aside class="left-side sidebar-offcanvas">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      <li <?php echo $a1; ?>><a href="#"><span>Profile</span><i class="glyphicon glyphicon-user" style="margin-left: 135px;"></i></a></li>
     
      <li class="treeview <?php echo $a4; ?>"> <a href="#"> <span>My Leaves</span> <i class="fa fa-angle-left pull-right"></i> </a>
        <ul class="treeview-menu">
          <li <?php echo $a2; ?>><a href="principal_history.php"><i class="fa fa-angle-double-right"></i>Leave History</a></li>
           <li <?php echo $a2; ?>><a href="principal_approvedleave.php"><i class="fa fa-angle-double-right"></i>Approved Leaves</a></li>
            <li <?php echo $a2; ?>><a href="principal_rejectedleave.php"><i class="fa fa-angle-double-right"></i>Rejected Leaves</a></li>
            <li <?php echo $a2; ?>><a href="mypending_principal.php"><i class="fa fa-angle-double-right"></i>Pending Leaves</a></li>
        </ul>
      </li>
      ...
      <li class="treeview <?php echo $a6; ?>"> <a href="#"> <span>Leave Management</span> <i class="fa fa-angle-left pull-right"></i> </a>
        <ul class="treeview-menu">
            ...
            <li <?php echo $a3; ?>><a href="hod_pending.php"><i class="fa fa-angle-double-right"></i>Pending Leaves HOD</a></li>
            <li <?php echo $a3; ?>><a href="faculty_pending_principal.php"><i class="fa fa-angle-double-right"></i>Pending Leaves Faculty</a></li>
        </ul>
      </li>
     
<li  <?php echo $a1; ?>><a href="changepassword_principal.php"><span>Change Password</span></a></li>
