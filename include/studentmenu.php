...
<aside class="left-side sidebar-offcanvas">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li <?php echo $a1; ?>><a href="student_profile.php?id=<?php echo $_SESSION['id']; ?>"><span>Profile</span><i class="glyphicon glyphicon-user" style="margin-left: 135px;"></i></a></li>
     
      <li class="treeview <?php echo $a4; ?>"> <a href="#"> <span>My Leaves</span> <i class="fa fa-angle-left pull-right"></i> </a>
        <ul class="treeview-menu">
          <li <?php echo $a2; ?>><a href="student_history.php"><i class="fa fa-angle-double-right"></i>Leave History</a></li>
             <li <?php echo $a2; ?>><a href="student_approved.php"><i class="fa fa-angle-double-right"></i>Approved Leave</a></li>
                <li <?php echo $a2; ?>><a href="student_rejected.php"><i class="fa fa-angle-double-right"></i>Rejected Leave</a></li>
               <li <?php echo $a2; ?>><a href="mypending.php"><i class="fa fa-angle-double-right"></i>Pending Leave</a></li>
        </ul>
      </li>
     
      
       <li <?php echo $a3; ?>><a href="changepassword_student.php" ><i class="fa fa-angle-left pull-right"></i>Change Password</a></li>
