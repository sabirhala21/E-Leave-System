...
{
    $query = 'select * from hodleave where id='.$_GET['id'];
...
<html>
    ...
    ?>
                ...
                <hr/>
                <input type="submit" class="btn btn-primary" value="<?php echo($action !='action.php?action=update' ? "Save" : "Update")?>"  id="btn_hod" name="btn_hod" />               
                <a href="hod_history.php" class="btn btn-primary">Cancel</a>
                </div> <!--wrapper div end-->
                    </form>
