                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                         ...
                                         <?php 
                                            $Srno=0;
                                            $query="select principalleave.id,principalreg.userid,principalleave.leavetype,principalleave.applyeddate,principalleave.status,principalleave.adminremark,principalleave.adminremarkdate from principalleave join principalreg on principalleave.empid=principalreg.id where principalleave.status='pending'";
