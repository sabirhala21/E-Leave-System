<?php
   include ('config.php');
   $id=$_GET['id'];
  $query="select * from hodreg where id='$id'";
...
<html>
    ...
    ?> 
                        ...
                        <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="mono" id="word_title" value="<?php echo $raw['mono']; ?>" required="" aria-required="true" pattern ="[0-9]+" maxlength="10">
                                <input type="hidden" name="hidden_id" value="">
                        </div>
                ...
                <hr>
                <input type="submit" class="btn btn-primary" value="Update" id="btnnews" name="hod_update">               
