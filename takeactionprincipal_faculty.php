                     ...
                     ?>
                                          ...
                                          <tr>
                                           ...
                                           <tr>
                                            ...
                                            <td style="font-size:16px;"> <b>Principal Remark Date:</b></td>
                                              <td><?php echo $row['principalremarkdate']; ?></td>
                                          </tr>
                                          <tr>
                                            <td style="font-size:16px;"> <b> HOD Leave Status:</b></td>
...
if($stats1=='pending'){
 ...
 <?php } ?>
                                             ...
                                             <td style="font-size:16px;"> <b> Principal Leave Status:</b></td>
...
if($stats2=='pending'){
 ...
 <?php } ?>
                                        ...
                                        <tr>
                                          ...
                                          <input type="submit" name="takeaction_faculty" value="Take Action" class="btn btn-primary">
                                          </td>
                                           </tr>
                   <?php 
                 }
