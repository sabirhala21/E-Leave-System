...
if($stats=='pending'){
 ...
 <?php } ?>
                                             ...
                                             <input type="hidden" name="hid" value="<?php echo $row["id"]; ?>">
                                              <td style="width:50px"><a href="takeactionfaculty_student.php?id=<?php echo $row['id']; ?>" class="btn btn-primary pull-right"><span class="fa fa-plus">&nbsp;View Details</span> </a></td> 
                                        </tr>
									 <?php }} ?>           
                                        </tbody>
