                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                 <th>No.</th>  
                                                 <th>Name</th>                                           
                                                 <th>Leave Type</th><th>From Date</th><th>To date</th><th>Discription</th><th>Posting Date</th><th>Admin Remark</th><th>Status</th>
                                        ...
                                        <tbody>
                                         <?php 
                                            $Srno=0;
                                            $que="select principalleave.id,principalreg.userid,principalleave.leavetype,principalleave.fromdate,principalleave.todate,principalleave.discription,principalleave.applyeddate,principalleave.adminremark,principalleave.adminremarkdate,principalleave.status from principalleave join principalreg on principalleave.empid=principalreg.id";
